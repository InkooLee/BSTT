...
The following Figure (Figure 1 in the main text) shows checkerboard pattern impeding straightforward interpretation.

```{r, echo=FALSE, fig.align='center', fig.width=7, fig.height=3, warning=FALSE}
setwd("C:/Users/inkku/Downloads")

load("PPD_BSTT_TN.rda")
load("CAL_BSTT_TN.rda")

t = 28; s = 6; b = 2;

PPD_B.est <-PPD_BSTT_TN$B.est[2:6,1:(t*s),]
CAL_B.est <-CAL_BSTT_TN$B.est[2:6,1:(t*s),]
